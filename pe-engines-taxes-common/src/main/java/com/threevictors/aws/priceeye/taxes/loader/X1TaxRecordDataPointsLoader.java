...
public class X1TaxRecordDataPointsLoader {
    ...
    public static Map<String, X1TaxRecordDataPoints> loadTaxRecordDataPoints(String filePath) {
     ...
     * @return
     */
    public static Map<String, X1TaxRecordDataPoints> loadTaxRecordDataPoints(InputStream in) {
        Map<String, X1TaxRecordDataPoints> x1TaxRecordDataPointsMap = new HashMap<>();
